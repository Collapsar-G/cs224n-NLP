...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        if transition == 'S':
            ...
            depend = self.stack.pop(-1)
            self.dependencies.append((self.stack[-1], depend))
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while len(unfinished_parses) > 0:
        ...
        for transla, parse in zip(transitions, unfinished_parses[:batch_size]):
            parse.parse_step(transla)
