...
class ParserModel(nn.Module):
    ...
    PyTorch Notes:
        ...
        - The "__init__" method Note that "ParserModel" is a subclass of the "nn.Module" class. In PyTorch all neural networks
            are a subclass of this "nn.Module"is where you define all the layers and parameters
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden_weight = nn.Parameter(
            torch.tensor(np.zeros((self.embed_size * self.n_features, self.hidden_size))).float())
