...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    for word in outsideWords:
        id_outside = word2Ind[word]
        loss_min, gradCenter_min, gradOutside_min = \
            word2vecLossAndGradient(centerWordVec=centerWordVec,
                                    outsideWordIdx=id_outside, outsideVectors=outsideVectors, dataset=dataset)
        loss += loss_min
        gradCenterVecs[center_id] += gradCenter_min
        gradOutsideVectors += gradOutside_min
    ### END YOUR CODE
